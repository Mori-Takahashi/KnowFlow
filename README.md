...
Node.js-Service, der Jira-Tickets beim Statuswechsel auf **Erledigt** automatisch
als Markdown-Wissensartikel in eine oder mehrere **Open WebUI**-Wissensbasen
überträgt. Routing-Regeln, Feld-Zuordnung und Verbindungs-Daten werden zur
Laufzeit über ein passwortgeschütztes **Admin-Dashboard** verwaltet und
verschlüsselt in SQLite abgelegt.

Eine Live-Dashboard-WebUI (Bootstrap 5, React via CDN, Socket.IO) zeigt
...
public/                  # WebUI (Bootstrap + React via CDN, kein Build)
  index.html
  app.jsx · sidebar.jsx · home.jsx · tickets.jsx
  data.jsx · admin.jsx · extras.jsx · styles.css
